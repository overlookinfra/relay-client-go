...
func (o *UserTokenWithSecret) GetInternal() bool {
...
// and a boolean to check if the value has been set.
func (o *UserTokenWithSecret) GetInternalOk() (*bool, bool) {
	if o == nil || o.Internal == nil {
		return nil, false
	}
...
func (o *UserTokenWithSecret) HasInternal() bool {
	if o != nil && o.Internal != nil {
		return true
	}
...
func (o *UserTokenWithSecret) SetInternal(v bool) {
	o.Internal = &v
}
